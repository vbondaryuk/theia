...
public class DroolsRuleFactory {
	...
	public DroolsRuleFactory()  throws Exception {
		this(new String[0]);
	}

	public DroolsRuleFactory(String[] assemblyQualifiedName) throws Exception {
	...
	public DroolsRuleFactory AddRule(String source) {
	...
	public DroolsRuleFactory AddObject(Object obj) {
	...
	public DroolsRuleFactory RetractObjects() {
	...
	public DroolsRuleFactory FireAllRules() {
